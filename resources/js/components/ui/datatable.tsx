...
export function DataTable<TData, TValue>({ columns, data, onSearchRoute, filters }: DataTableProps<TData, TValue>) {
    ...
    return (
        <div>
            ...
            <div className="roounded-md rounded-md border px-3 py-2 shadow-sm">
                <Table>
                    <TableHeader>
